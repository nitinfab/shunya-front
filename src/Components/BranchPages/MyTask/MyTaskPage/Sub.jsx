...
function Sub() {
  ...
  const handleOptionSelect3 = (option, index) => {
    ...
    setSelectedValues3((prevState) => {
      ...
      if(option==="Done"){
        updatedTask = updateArray.map((ele, ind) => {
          if (
            ele.title ===
            pageName[5].charAt(0).toUpperCase() + pageName[5].slice(1)
          ) {
            return {
              ...
              cards: ele.cards.map((card, cardIndex) => {
                if (card._id === TaskInfoStateValue.taskInfoTask._id) {
                  return {
                    ...card,
  ...
  const handleOptionSelect4 = (option, index) => {
    setSelectedValues4((prevState) => {
      ...
      //   console.log("YTtgvbvdsAALLPlp",updatedTask.find((ele,ind) => {
      //     if( ele.title ===
      //      pageName[5].charAt(0).toUpperCase() + pageName[5].slice(1))
      //      return ele;
      //    }).cards.find((ele,ind)=>{
  ...
  return (
    <>
      <div style={{ maxHeight: "60%", height: "60%" ,overflow:"scroll"}}>
        {myTaskState &&
                ...
                <>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {/* {console.log("ashhsa",selectedValues5[ind]?.image,selectedValues5[ind]?.value)} */}
      ...
      <div style={{ maxHeight: "25%", maxHeight: "25%", marginTop: "1rem" ,overflow:"scroll"}}>
        {myTaskState1 &&
